...
*Instructions*
In order to run and play in the casino, one must first launch the driver class Casino. By executing the file, one will be 
able to start up the casino.

Upon launching the casino, the player will be prompted to either login to a pre-existing account or create a new account. If 
...
After entering the casino, the player will have a broad selection of games that they can choose from. Each of these games 
...
Although there is no ultimate way to win this casino, the general goal is to win as much money as you can. Most 
